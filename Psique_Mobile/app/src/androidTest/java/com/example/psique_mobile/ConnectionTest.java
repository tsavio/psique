...
public class ConnectionTest {
    ...
    private Credential getCredentials(final NetHttpTransport HTTP_TRANSPORT) throws IOException {
        // Load client secrets.
        InputStream in = ConnectionTest.class.getResourceAsStream(CREDENTIALS_FILE_PATH);
        if (in == null) {
    ...
    public static void sendHangout(Context ctx, String message, String urlShare, String imgPath) throws IOException {
