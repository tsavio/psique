...
export class DoctorService {
    ...
    getAll() {
        return this.http.get(`${this.API}/doctor`, {headers: {
    ...
    store(data) {
        return this.http.post(`${this.API}/auth/register`, data, {headers: {
            userId: JSON.parse(sessionStorage.getItem('user')).id
    ...
    getAllATime() {
        return this.http.get(`${this.API}/availability`, {headers: {
            userId: JSON.parse(sessionStorage.getItem('user')).id
        }}).pipe(take(1));
    }
    storeATime(data){
